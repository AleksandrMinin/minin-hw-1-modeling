...
BATCH_SIZE = 200
N_EPOCHS = 50
ROOT_PATH = os.path.join(os.environ.get("ROOT_PATH")) # "/storage/minin/datasets/planet-from-space" 
...
config = Config( 
    ...
    experiment_name=f'experiment_3_{datetime.now().strftime("%Y-%m-%d_%H:%M:%S")}',
)
